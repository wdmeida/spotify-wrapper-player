...
import convertToHumamTime from '../src/ConvertToHumanTime';
...
describe('AlbumTracks', () => {
  ...
  const markup = `
    <div class="music" data-track-preview="https://p.scdn.co/mp3-preview/ab3d501c5ffbf560e94094f76cd36d874a26e941?cid=8897482848704f2a8f8d7c79726a70d4">
      ...
      <p class="music-duration">${convertToHumamTime(238733)}</p>
    </div>`;
  ...
  it('should create and appent the markup when more than 1 track data', () => {
